...
//    {label:'Workshop id', name:'workshopId',  type:'text', placeholer:'Workshop Id'},    
    {label:'Name (shown to customer)', name:'name',  type:'textarea', placeholder:'Name in english', required:true, unique:true, maxlength:100},    
    {label:'Shortname', name:'workshopId',  type:'text', placeholder:'Short name', required:true, unique:true, maxlength:30},    
